...
class FrontFieldEmailTemplateSeeder extends Seeder
{
    public function run()
    {
        $templates = [
            ...
            [
                ...
                'subject' => 'Verify Your Email Address - FrontField Credit Union',
                'title' => 'Email Verification Required',
                'salutation' => 'Hello [[full_name]]',
                'message_body' => 'Welcome to FrontField Credit Union. To ensure the security of your account and activate your full digital banking features, please verify your email address. This step helps us protect your sensitive financial information.',
            ...
            [
                ...
                'footer_body' => 'FrontField FCU Security Team',
            ],
            [
                ...
                'message_body' => 'To complete your requested action (<strong>[[action]]</strong>), please enter the authorization code provided below:<br><br><div style="text-align:center; font-size: 32px; font-weight: bold; color: #00549b; letter-spacing: 5px; padding: 20px; background: #f8fafc; border-radius: 8px; margin: 20px 0;">[[otp_code]]</div><br>This code will expire in 10 minutes. <strong>FrontField FCU will never ask for this code over the phone or via text.</strong>',
                'footer_body' => 'Always Secure. Always FrontField.',
            ],
            [
                ...
                'footer_body' => 'FrontField Credit Union Member Support',
            ],
            [
                ...
                'footer_body' => 'FrontField Credit Union | Your Security is Our Priority',
            ],
            [
            ...
            [
                ...
                'footer_body' => 'Team FrontField Credit Union',
            ],
            [
            ...
            [
                ...
                'salutation' => 'Hi [[full_name]]',
                'message_body' => 'Your internal transfer has been completed. Status: <strong>[[status]]</strong>.<br><br><strong>Summary:</strong><br>From: [[from_account]]<br>To: [[to_account]]<br>Amount: [[amount]]<br>Fee: [[charge]]<br>Total Deducted: [[total_amount]]',
            ...
            [
                ...
                'salutation' => 'Hello [[full_name]]',
                'message_body' => 'We are writing to update you on your recent deposit request to <strong>[[to_account]]</strong>. The transaction status is currently: <strong>[[status]]</strong>.<br><br><strong>Transaction Details:</strong><br>ID: [[txn]]<br>Gateway: [[gateway_name]]<br>Amount: [[deposit_amount]]<br><br>[[message]]',
            ...
            [
                ...
                'subject' => 'Transfer Approved: [[to_account]]',
                'title' => 'Transfer Success',
                'salutation' => 'Hi [[full_name]]',
                'message_body' => 'Great news! Your transfer of <strong>[[amount]]</strong> has been approved and processed.<br><br><strong>Transaction Summary:</strong><br>From: [[from_account]]<br>To: [[to_account]]<br>Amount: [[amount]]<br>Fee: [[charge]]<br>Total Deducted: [[total_amount]]<br><br>Memo: [[memo]]',
                'footer_body' => 'Reliable. Secure. FrontField.',
            ],
            [
                'name' => 'Member Transfer Rejected',
                'code' => 'member_transfer_rejected',
                'subject' => 'Transfer Update: [[to_account]]',
                'title' => 'Transfer Notice',
                'salutation' => 'Hi [[full_name]]',
                'message_body' => 'We were unable to process your transfer of <strong>[[amount]]</strong> to <strong>[[to_account]]</strong>.<br><br><strong>Details:</strong><br>From: [[from_account]]<br>Reason: [[message]]<br><br>The funds (including fees) have been returned to your account.',
                'footer_body' => 'Questions? We are here to help.',
            ],
            [
                'name' => 'External Transfer Approved',
                'code' => 'external_transfer_approved',
                'subject' => 'External Transfer Processed: [[amount]]',
                'title' => 'External Transfer Update',
                'salutation' => 'Hi [[full_name]]',
                'message_body' => 'Your external transfer request has been successfully processed.<br><br><strong>Transaction Details:</strong><br>From: [[from_account]]<br>To: [[to_account]]<br>Bank: [[bank_name]]<br>Amount: [[amount]]<br>Merchant/Fee: [[charge]]<br>Total: [[total_amount]]',
                'footer_body' => 'Thank you for choosing FrontField FCU.',
            ],
            [
                'name' => 'External Transfer Rejected',
                'code' => 'external_transfer_rejected',
                'subject' => 'External Transfer Declined',
                'title' => 'External Transfer Update',
                'salutation' => 'Hi [[full_name]]',
                'message_body' => 'Your external transfer request to <strong>[[to_account]]</strong> has been declined.<br><br><strong>Reason:</strong> [[message]]<br><br>Funds have been returned to your [[from_account]] account.',
                'footer_body' => 'Please contact us for more information.',
            ],
            [
                'name' => 'Remote Deposit Approved',
                'code' => 'remote_deposit_approved',
                'subject' => 'Remote Deposit Credit: [[check_amount]]',
                'title' => 'Check Deposit Success',
                'salutation' => 'Hi [[full_name]]',
                'message_body' => 'Your remote check deposit for <strong>[[check_amount]]</strong> has been cleared and credited to your <strong>[[to_account]]</strong>.<br><br><strong>Details:</strong><br>Capture Date: [[capture_date]]<br>Credit Date: [[date]]<br>Amount: [[check_amount]]',
                'footer_body' => 'Safe. Secure. Remote Banking.',
            ],
            [
                'name' => 'Remote Deposit Rejected',
                'code' => 'remote_deposit_rejected',
                'subject' => 'Remote Deposit Update: Check Returned',
                'title' => 'Check Deposit Notice',
                'salutation' => 'Hi [[full_name]]',
                'message_body' => 'We were unable to process your remote check deposit of <strong>[[check_amount]]</strong>.<br><br><strong>Reason:</strong> [[message]]<br><br>Please note that a returned check fee may apply. Contact support for further details.',
            ...
            [
                ...
                'salutation' => 'Dear [[full_name]]',
                'message_body' => 'Congratulations! You have achieved the <strong>[[portfolio_name]]</strong> status. This milestone reflects your continued trust and activity with FrontField Credit Union. We have applied your membership rewards to your account balance.',
            ...
            [
                ...
                'salutation' => 'Hi [[full_name]]',
                'message_body' => 'Great news! You have just earned <strong>[[points]]</strong> reward points for your recent activity. Thank you for being an active member of FrontField Credit Union.',
            ...
            [
                ...
                'footer_body' => 'FrontField Credit Union',
            ],
            [
