DROP TABLE IF EXISTS `others_banks`;

CREATE TABLE `others_banks` (
  ...
  `charge_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'percent',
  `minimum_transfer` decimal(15,2) NOT NULL DEFAULT '0.00',
  `maximum_transfer` decimal(15,2) NOT NULL DEFAULT '0.00',
  `daily_limit_maximum_amount` decimal(15,2) NOT NULL DEFAULT '0.00',
  `daily_limit_maximum_count` int(11) NOT NULL DEFAULT '0',
  `monthly_limit_maximum_amount` decimal(15,2) NOT NULL DEFAULT '0.00',
  `monthly_limit_maximum_count` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `others_banks` (`name`, `code`, `processing_time`, `processing_type`, `charge`, `charge_type`, `minimum_transfer`, `maximum_transfer`, `daily_limit_maximum_amount`, `daily_limit_maximum_count`, `monthly_limit_maximum_amount`, `monthly_limit_maximum_count`, `field_options`, `details`, `status`, `created_at`, `updated_at`) VALUES
