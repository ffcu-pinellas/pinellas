...
echo "<h1 style='color: #ff4d4d;'>Manual Cache Destroyer</h1>";
...
try {
    ...
    echo "Artisan call failed (standard for some shared hosts): " . $e->getMessage() . "<br>";
}
