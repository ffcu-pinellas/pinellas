...
trait Payment
{
    ...
    {
        // Many of the previous payment classes were removed during the Pinellas transition.
        // If automatic payment logic is needed again, the corresponding classes in App\Payment must be restored.
        return false;
    }
}
