...
class WithdrawController extends Controller
{
    ...
    public function methodCreate($type)
    {
        ...
        return view('backend.withdraw.method_create', compact('button', 'type'));
    }
    ...
    public function methodEdit($type)
    {
        ...
        return view('backend.withdraw.method_edit', compact('button', 'withdrawMethod', 'type'));
    }
    ...
    public function history(Request $request)
    {
        ...
        $search = $request->search ?? null;
        $withdrawals = Transaction::with('user')
            ->whereIn('type', [TxnType::Withdraw->value])
            ->search($search)
