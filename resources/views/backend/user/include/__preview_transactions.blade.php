                ...
                <div class="modal-body">
                    <div class="alert alert-info mb-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <strong>{{ __('Preview Mode:') }}</strong> {{ __('These transactions have not been saved yet.') }}<br>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-6">
                            <form action="{{ route('admin.user.transactions.generate-commit', $user->id) }}" method="POST">
                                @csrf
                                <button type="submit" class="site-btn primary-btn w-100"><i data-lucide="check-circle"></i> {{ __('Confirm & Save') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
