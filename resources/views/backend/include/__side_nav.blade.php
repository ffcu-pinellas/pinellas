        ...
        <ul class="side-nav-menu">
                    ...
                    <li class="side-nav-item side-nav-dropdown {{ isActive(['admin.user*', 'admin.notification*']) }}">
                        ...
                        <ul class="dropdown-items">
                            @canany(['customer-list', 'customer-login', 'customer-mail-send', 'customer-basic-manage', 'customer-balance-add-or-subtract', 'customer-change-password', 'all-type-status', 'officer-user-manage'])
                                        ...
                                        @if(auth('admin')->check() && !auth('admin')->user()->hasAnyRole(['Account Officer', 'Account-Officer'], 'admin'))
            ...
            *********************************************************--}}
            ...
            @canany((['subscriber-list', 'subscriber-mail-send', 'support-ticket-list', 'support-ticket-action', 'email-template', 'sms-template', 'sms-template', 'push-notification-template', 'officer-support-ticket-manage']))
                ...
                @canany(['subscriber-list', 'subscriber-mail-send', 'support-ticket-list', 'support-ticket-action', 'officer-support-ticket-manage'])
