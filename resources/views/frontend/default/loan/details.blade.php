                ...
                <div class="site-card">
                    <div class="site-card-header">
                        ...
                        @if($loan->status == App\Enums\LoanStatus::Running || $loan->status == App\Enums\LoanStatus::Due)
                            <div class="card-header-links d-flex">
                                <button type="button" data-url="{{ route('user.loan.pay.installment', ['loan_id' => encrypt($loan->id)]) }}" class="site-btn-sm polis-btn payLoanInstallment">
                                    ...
                                    <div class="site-table-list">
                                        ...
                                        <div class="site-table-col text-center">
                                            @if($trx->given_date == null)
                                                <button type="button" data-url="{{ route('user.loan.pay.installment', ['loan_id' => encrypt($loan->id), 'trans_id' => encrypt($trx->id)]) }}" class="site-btn-sm polis-btn payLoanInstallment">
                                                    <i data-lucide="send"></i>
                                                    {{ __('Pay Installment') }}
                                                </button>
                                            @else
