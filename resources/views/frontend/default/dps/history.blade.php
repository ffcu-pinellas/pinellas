        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
            <div class="site-card">
                <div class="site-card-header">
                    <div class="title-small">{{ __('My Certificate of Deposits List') }}</div>
                    <div class="card-header-links">
                        <a href="{{ route('user.dps.index') }}" class="card-header-link"><i
                                data-lucide="archive"></i>{{ __('CDs Plans') }}</a>
                    </div>
                </div>
                    ...
                    <div class="site-custom-table">
                        <div class="contents">
                            <div class="site-table-list site-table-head">
                                <div class="site-table-col">{{ __('CD Name') }}</div>
                                <div class="site-table-col">{{ __('CD ID') }}</div>
