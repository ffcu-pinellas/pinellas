        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
            <div class="site-card">
                <div class="site-card-header">
                    <div class="title-small">{{ __('IRA Details:') }}</div>
                    <div class="card-header-links d-flex">
                        @if($fdr->plan?->is_add_fund_fdr == 1)
                            <a href="javascript:void(0)" class="card-header-link" data-bs-toggle="modal" data-bs-target="#increment">
                                <i data-lucide="plus"></i>
                                {{ __('Increase') }}
                            </a>
                        @endif
                        @if($fdr->plan?->is_deduct_fund_fdr == 1)
                            <a href="javascript:void(0)" class="bg-danger card-header-link" data-bs-toggle="modal" data-bs-target="#decrement">
                ...
                <div class="site-card-body p-0 overflow-x-auto">
                    <div class="site-custom-table site-custom-table-sm">
                        <div class="contents">
                            ...
                            <div class="site-table-list">
                                <div class="site-table-col">
                                    <div class="trx fw-bold">{{ __('IRA ID:') }}</div>
                                </div>
                                <div class="site-table-col">
