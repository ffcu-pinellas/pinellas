        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
            <div class="site-card">
                <div class="site-card-header">
                    <div class="title-small">{{ __('My IRA List') }}</div>
                    <div class="card-header-links">
                        <a href="{{ route('user.fdr.index') }}" class="card-header-link"><i
                                data-lucide="archive"></i>{{ __('IRA List') }}
                        </a>
                    </div>
                </div>
                    ...
                    <div class="site-custom-table">
                        <div class="contents">
                            <div class="site-table-list site-table-head">
                                <div class="site-table-col">{{ __('IRA Name') }}</div>
                                <div class="site-table-col">{{ __('IRA ID') }}</div>
                    ...
                    <div class="modal-content site-table-modal">
                        <div class="modal-body popup-body">
                            ...
                            <div class="popup-body-text centered">
                                ...
                                <p>
                                    {{ __('You want to Cancel this IRA?') }}
                                </p>
