        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
            <div class="site-card">
                <div class="site-card-header">
                    <div class="title">{{ __('IRA Plans') }}</div>
                    <div class="card-header-links">
                        <a href="{{ route('user.fdr.history') }}" class="card-header-link"><i
                                data-lucide="archive"></i>{{ __('My IRAs') }}</a>
                    </div>
                </div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 col-12">
                                <div class="plan-card-box">
                                    ...
                                    <div class="list">
                                        ...
                                        <div class="single">
                                            <div><span><i data-lucide="check"></i></span>{{ __('Minimum IRA') }}</div>
                                            <div>{{ $plan->minimum_amount }} {{ $currency }}</div>
                                        </div>
                                        <div class="single">
                                            <div><span><i data-lucide="check"></i></span>{{ __('Maximum IRA') }}</div>
