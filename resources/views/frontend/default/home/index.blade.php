...
<section class="sand" role="complementary">
    ...
    <div class="center slider">
        <div><div class="holder"><h2><a href="{{ route('login') }}"><img alt="auto" src="{{ asset('assets/external/images/loans-promo.jpg') }}" loading="lazy" /></a></h2><h2 style="text-align: center;"><strong>We've Got You Covered!</strong></h2><p>We have loans to help you through every stage of life. Call us at 216 230 1837 or stop by one of the branches to apply.</p></div></div>
        <div><div class="holder"><h2><a href="{{ route('register') }}"><img alt="membership" src="{{ asset('assets/external/images/membership-promo.jpg') }}" loading="lazy" /></a></h2><h2 style="text-align: center;"><strong>Our Members Are Family</strong></h2><p>Since 1956, {{ (setting('site_title', 'global') && str_contains(setting('site_title', 'global'), 'Pinellas')) ? 'PFCU' : 'FFCU' }} has offered an array of benefits to help members reach financial wellness. </p><p> <a class="cta" href="{{ route('register') }}">BECOME A MEMBER</a></p></div></div>
...
<section class="P2" role="complementary">
    <div class="liner">
        <div class="imgbox" style="background-image: url({{ asset('assets/external/images/autosmart.jpg') }});"></div>
