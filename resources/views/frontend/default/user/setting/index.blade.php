                ...
                <div class="p-4 bg-white">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="javascript:void(0)" onclick="tNotify('info', 'For your security, usernames can only be changed by contacting support.', 'Security Notice')" class="text-decoration-none small fw-bold">Edit</a>
                        </div>
                    </div>
