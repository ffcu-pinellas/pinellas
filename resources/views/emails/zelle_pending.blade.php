...
<body>
    <div class="email-container">
        ...
        <div class="header" style="background-color: #741B6B; padding: 30px; text-align: center;">
            <img src="{{ asset('assets/external/images/Zelle-logo-no-tagline-white.png') }}" alt="Zelle" style="max-height: 40px; display: inline-block;">
        </div>
        ...
        <div class="content">
            ...
            <div style="text-align: center;">
                ...
                <h3 style="margin-top:5px; color:#222;">{{ data_get($transaction->meta_data, 'zelle_contact', 'Recipient') }}</h3>
            </div>
