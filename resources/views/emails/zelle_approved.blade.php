...
<body>
    <div class="email-container">
        <div class="header">
            <img src="{{ asset('assets/external/images/zelle logo2025.png') }}" alt="Zelle">
        </div>
        ...
        <div class="content">
            ...
            <div style="text-align: center;">
                ...
                <p style="margin:0; color:#666;">was delivered to</p>
            ...
            <div class="details-box">
                <div class="details-row">
                    ...
                    <span class="value text-success">Delivered/Completed</span>
                </div>
                <div class="details-row">
