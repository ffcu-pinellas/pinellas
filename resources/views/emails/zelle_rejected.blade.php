...
<head>
    <style>
        ...
        .header { background: linear-gradient(135deg, #6d1ed4 0%, #4B1045 100%); padding: 25px 24px; text-align: left; border-bottom: 1px solid rgba(255,255,255,0.1); }
        ...
        .details-box { background-color: #f9f9f9; border-top: 2px solid #dc3545; padding: 20px; margin: 25px 0; border-radius: 4px; }
        ...
        <div class="content">
            ...
            <div class="details-box">
                ...
                <div class="details-row">
                    ...
                    <span class="value">{{ strtoupper($recipient) }}</span>
                </div>
                <div class="details-row">
