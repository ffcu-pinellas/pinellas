# Guide: Building the Signed APK for FrontField Admin Mobile App

Follow these steps to generate a professional, signed APK ready for installation on your Android devices.

## 1. Prerequisites
- **Android Studio** installed.
- Your **Admin App Folder** (`FrontField FCU ADMIN APP`) ready.
...
```
(Run this command in the `FrontField FCU ADMIN APP` directory).
